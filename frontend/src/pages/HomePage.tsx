    ...
    <div className="p-6 max-w-7xl mx-auto">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
        ...
        >
          <div className="flex items-start justify-between">
            <div>
              ...
              <p className="text-sm text-gray-500">开始创建新的流程图</p>
            </div>
        ...
        <div className="card p-6">
          ...
          <p className="text-sm text-gray-500">使用智谱AI大模型生成高质量图表</p>
        </div>
        ...
        <div className="card p-6">
          ...
          <p className="text-sm text-gray-500">草稿、生成、组装三种模式</p>
        </div>
      </div>
      ...
      <div>
        ...
        {loading ? (
          ...
          <div className="card p-12 text-center">
            ...
            <p className="text-gray-500 mb-4">创建您的第一个流程图项目</p>
